...
public class Usuario {
    ...
    @NotBlank(message = "Senha é obrigatória e deve conter ao menos 6 caracteres")
    @Size(min = 6, max = 100)
    ...
    @NotNull(message = "Role do usuário é obrigatória e deve ser DONO ou CLIENTE")
    ...
    private void validate(String nome, String email, String login, String senha, Date dataAlteracao, String endereco, RoleUsuario role) {
        ...
        if (senha == null || senha.length() < 6) {
            throw new DomainException("Senha é obrigatória e deve conter ao menos 6 caracteres");
        }
        ...
        if (role == null) {
            throw new DomainException("Role do usuário é obrigatória e deve ser DONO ou CLIENTE");
        }

        if (!EnumSet.of(RoleUsuario.DONO, RoleUsuario.CLIENTE).contains(role)) {
            throw new DomainException("Role deve ser DONO ou CLIENTE");
        }
    }
